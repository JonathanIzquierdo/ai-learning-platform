...
const content = {
  en: {
    ...
    takeaways: [
      'Tokens are the unit of cost — every character in and out counts.',
  ...
  return (
    <div className="py-12 flex flex-col justify-center min-h-[70vh]">
      <motion.div initial={{ scale: 0.8, opacity: 0 }} animate={{ scale: 1, opacity: 1 }}
        className="text-4xl mb-6">{c.badge}</motion.div>
      ...
      <div className="bg-blue-600/10 border border-blue-600/30 rounded-xl p-4 text-center text-sm text-blue-400 font-semibold">
        {c.cta}
      </div>
    </div>
  )
