...
const content = {
  en: {
    ...
    stats: [
      { value: '2×', label: 'Copilot weekly costs since Jan 2026' },
      { value: '$840k', label: 'Estimated extra annual cost for Visma' },
      { value: 'Jun 1', label: 'Token billing goes live' },
    ]
  },
  es: {
    ...
    stats: [
      { value: '2×', label: 'Costos semanales de Copilot desde ene 2026' },
      { value: '$840k', label: 'Costo anual adicional estimado para Visma' },
      { value: '1 Jun', label: 'Arranca el cobro por tokens' },
    ]
  }
}
  ...
  return (
    <div className="flex flex-col justify-center min-h-[70vh] py-12">
      ...
      <motion.p initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.2 }}
        className="text-slate-300 text-xl mb-12 max-w-xl leading-relaxed">{c.body}</motion.p>
