...
const content = {
  en: {
    question: 'Your agent has been retrying a failing test for 20 minutes. What should you do?',
    options: [
      ...
      'Open a parallel session to tackle it from another angle',
    ],
    correct: 1,
  },
  es: {
    question: 'Tu agente lleva 20 minutos reintentando un test que falla. ¿Qué hacés?',
    options: [
